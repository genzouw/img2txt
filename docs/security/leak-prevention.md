...
1. **Zoom API Token の検知**: Zoom の API キーやシークレット、OAuth トークンを検知対象としました。
2. **Dropbox API Token の検知**: Dropbox の API トークンおよび Access Token (Short-lived token 含む) を検知対象としました。
